...
%plotdefs=(
 ...
 'GX'=>{
   'TEXT'        => 'Max Wind Gust',
   'CONT_CLASS'  => 9,
   'CONT_LIM'=> '5.5,8.0,10.8,13.9,18.,24.5,28.,30.,32.6',
   'PRE_FCLA'=> '5.5,8.0,10.8,13.9,18.,24.5,28.,30.,32.6',
   'MAP_BIAS_INTERVAL'=> '-10.,-5.,-2.5,0.,2.5,5.,10.',
   'ACC'         => 1,
   'ACCTYPE'     => 3,
 },
 ...
 'DSN'=>{
   ...
   'LLIM'        => 0.,
   'CONT_CLASS'  => 7,
   'CONT_LIM'    => '0.,5.,10.,30.,50.,70.,100.',
   'PRE_FCLA'    => '0.,5.,10.,30.,50.,70.,100.',
   'MAP_BIAS_INTERVAL'=> '-50.,-20.,-5.,0.,5.,20.,50.',
 }, 
