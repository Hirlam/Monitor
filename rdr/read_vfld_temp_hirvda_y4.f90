SUBROUTINE read_vfld_temp_hirvda_y4
...
!----------------------------------------------------------
 ...
 TIME_LOOP : DO
    ...
    EXP_LOOP : DO l=1,nexp
       ...
       WRITE(cwrk(1:10),'(I8.8,I2.2)')cdate,ctime/10000
       ...
       IF (ierr.NE.0 .AND. print_read > 0 ) WRITE(6,*)'COULD NOT READ ',TRIM(fname)
...
END SUBROUTINE read_vfld_temp_hirvda_y4
