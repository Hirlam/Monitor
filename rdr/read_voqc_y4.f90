...
!----------------------------------------------------------
 ...
 !
       ...
       IF (print_read > 1 ) WRITE(6,*)'READ ',fname
       ...
       READ_STATION_OBS : DO k=1,num_stat
          ...
          IF (ABS(val(4)+99.) > 1.e-6 ) val(4) = val(4) - tzero
